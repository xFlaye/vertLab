...
Shader "niFractal"
{
	Properties
	{
		...
		[ASEBegin]_Zoomer("Zoomer", Range( 0.0001 , 2)) = 0.4236082
		_Center("Center", Vector) = (0.27,0.24,0,0)
		_Iterations("Iterations", Int) = 400
	...
	SubShader
	{
		...
		Pass
		{
			...
			float Mandelia20( float2 UV, int Iterations, float Threshold )
			{
				float2 r = UV;
				int step = 0;
				...
				return (float)step/(float)Iterations;
			}
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float2 texCoord10 = IN.ase_texcoord3.xy * float2( 2,2 ) + float2( -1,-1 );
				float2 UV20 = ( ( _Zoomer * texCoord10 ) + _Center );
				int Iterations20 = _Iterations;
				float Threshold20 = _Threshold;
				float localMandelia20 = Mandelia20( UV20 , Iterations20 , Threshold20 );
				float temp_output_26_0 = ( 1.0 - localMandelia20 );
				float3 appendResult31 = (float3(( 0.9 - ( 0.9 * temp_output_26_0 ) ) , temp_output_26_0 , temp_output_26_0));
				float3 break30 = appendResult31;
				float3 hsvTorgb28 = HSVToRGB( float3(break30.x,break30.y,break30.z) );
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = ( _Tint * float4( hsvTorgb28 , 0.0 ) ).rgb;
				float Alpha = localMandelia20;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 texCoord10 = IN.ase_texcoord2.xy * float2( 2,2 ) + float2( -1,-1 );
				float2 UV20 = ( ( _Zoomer * texCoord10 ) + _Center );
				int Iterations20 = _Iterations;
				float Threshold20 = _Threshold;
				float localMandelia20 = Mandelia20( UV20 , Iterations20 , Threshold20 );
        ...
        Pass
        {
			...
			half4 frag(VertexOutput IN ) : SV_TARGET
			{
				...
				float2 texCoord10 = IN.ase_texcoord.xy * float2( 2,2 ) + float2( -1,-1 );
				float2 UV20 = ( ( _Zoomer * texCoord10 ) + _Center );
				int Iterations20 = _Iterations;
				float Threshold20 = _Threshold;
				float localMandelia20 = Mandelia20( UV20 , Iterations20 , Threshold20 );
				
				surfaceDescription.Alpha = localMandelia20;
        ...
        Pass
        {
			...
			{
				SurfaceDescription surfaceDescription = (SurfaceDescription)0;
				float2 texCoord10 = IN.ase_texcoord1.xy * float2( 2,2 ) + float2( -1,-1 );
				float2 UV20 = ( ( _Zoomer * texCoord10 ) + _Center );
				int Iterations20 = _Iterations;
				float Threshold20 = _Threshold;
				float localMandelia20 = Mandelia20( UV20 , Iterations20 , Threshold20 );
...
/*ASEBEGIN
Version=18935
25;121;2354;1168;862.2615;563.2128;1.3;True;True
Node;AmplifyShaderEditor.Vector2Node;14;-813.2284,236.5524;Inherit;False;Constant;_Offset;Offset;0;0;Create;True;0;0;0;False;0;False;-1,-1;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.Vector2Node;13;-825.2284,-10.44765;Inherit;False;Constant;_Tiling;Tiling;0;0;Create;True;0;0;0;False;0;False;2,2;0,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;15;-512.2284,-64.44765;Float;False;Property;_Zoomer;Zoomer;0;0;Create;True;0;0;0;False;0;False;0.4236082;0.03;0.0001;2;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;10;-552.2284,79.55235;Inherit;True;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector2Node;19;-218.2284,433.5523;Float;False;Property;_Center;Center;1;0;Create;True;0;0;0;False;0;False;0.27,0.24;-0.75,0.13;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;18;-212.2284,19.55235;Inherit;True;2;2;0;FLOAT;0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RangedFloatNode;22;205.7159,683.6446;Inherit;False;Property;_Threshold;Threshold;3;0;Create;True;0;0;0;False;0;False;2;2;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;17;64.77161,262.5523;Inherit;True;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0,0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.IntNode;21;188.7158,558.6448;Inherit;False;Property;_Iterations;Iterations;2;0;Create;True;0;0;0;False;0;False;400;1000;False;0;1;INT;0
Node;AmplifyShaderEditor.CommentaryNode;32;597.3081,-387.694;Inherit;False;1264.818;385.0001;Comment;8;24;25;26;27;28;29;30;31;;1,1,1,1;0;0
Node;AmplifyShaderEditor.ColorNode;34;1700.814,-673.7275;Inherit;False;Property;_Tint;Tint;4;1;[HDR];Create;True;0;0;0;False;0;False;0,0,0,0;1.314039,0.9727036,0.923546,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;33;2158.225,-386.4317;Inherit;False;2;2;0;COLOR;0,0,0,0;False;1;FLOAT3;0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;24;656.1147,-289.2617;Float;False;Constant;_HueScale;HueScale;2;0;Create;True;0;0;0;False;0;False;0.9;2.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.DynamicAppendNode;31;1192.127,-161.6939;Inherit;False;FLOAT3;4;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;3;FLOAT;0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.CustomExpressionNode;35;568.1379,594.0514;Float;False;float2 r = UV@$int step = 0@$for (int i = 0@ i < MaxIter@ i++) ${$	if (length(r) > Threshold) $		break@$	$	r = mul( float2x2(r.x,-r.y,r.y,r.x) , r) + UV@$	step++@$}$return (float)step/(float)MaxIter@;1;Create;3;True;UV;FLOAT2;0,0;In;;Float;False;True;MaxIter;INT;0;In;;Float;False;True;Threshold;FLOAT;0;In;;Float;False;Mandlebrot;True;False;0;;False;3;0;FLOAT2;0,0;False;1;INT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.OneMinusNode;26;647.3081,-124.443;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleSubtractOpNode;29;1030.427,-290.5939;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.BreakToComponentsNode;30;1352.126,-177.6939;Inherit;False;FLOAT3;1;0;FLOAT3;0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;25;824.127,-241.6939;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.HSVToRGBNode;28;1624.126,-193.694;Float;False;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RangedFloatNode;27;824.127,-337.694;Float;False;Constant;_HueOffset;HueOffset;3;0;Create;True;0;0;0;False;0;False;0.9;0.95;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.CustomExpressionNode;20;530.7159,365.2447;Float;False;float2 r = UV@$int step = 0@$for (int i = 0@ i < Iterations@ i++)${$	if(length(r) > Threshold)$	{$		break@$	}$$	r = mul( float2x2(r.x,-r.y,r.y,r.x) , r) + UV@$	step++@$$}$$return (float)step/(float)Iterations@$$;1;Create;3;True;UV;FLOAT2;0,0;In;;Float;False;True;Iterations;INT;0;In;;Inherit;False;True;Threshold;FLOAT;0;In;;Inherit;False;Mandelia;True;False;0;;False;3;0;FLOAT2;0,0;False;1;INT;0;False;2;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;1;2139,50;Float;False;True;-1;2;UnityEditor.ShaderGraphUnlitGUI;0;3;niFractal;2992e84f91cbeb14eab234972e07ea9d;True;Forward;0;1;Forward;8;False;False;False;False;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;0;False;-1;False;False;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;2;True;17;d3d9;d3d11;glcore;gles;gles3;metal;vulkan;xbox360;xboxone;xboxseries;ps4;playstation;psp2;n3ds;wiiu;switch;nomrt;0;False;True;1;1;False;-1;0;False;-1;1;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForwardOnly;False;False;0;Hidden/InternalErrorShader;0;0;Standard;22;Surface;0;0;  Blend;0;0;Two Sided;1;0;Cast Shadows;1;0;  Use Shadow Threshold;0;0;Receive Shadows;1;0;GPU Instancing;1;637840283815797756;LOD CrossFade;0;0;Built-in Fog;0;0;DOTS Instancing;0;0;Meta Pass;0;0;Extra Pre Pass;0;0;Tessellation;0;0;  Phong;0;0;  Strength;0.5,False,-1;0;  Type;0;0;  Tess;16,False,-1;0;  Min;10,False,-1;0;  Max;25,False,-1;0;  Edge Length;16,False,-1;0;  Max Displacement;25,False,-1;0;Vertex Position,InvertActionOnDeselection;1;0;0;10;False;True;True;True;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=5C9E05537B21493DF02D1F69B2C3DFCD7935CE5C